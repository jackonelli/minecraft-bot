...
class PrioritizedReplayBuffer(ReplayBuffer):
    ...
    def save_samples(self,file_name='expert_transitions'):
        with open('{}.p'.format(file_name), 'wb') as handle:
    ...
    def load_samples(self,file_name='expert_transitions'):
        temp_trans = pickle.load(open("{}.p".format(file_name), "rb"))
        for i in temp_trans:
            self.add_sample(i)
        print("loaded transitions: ", len(temp_trans))
